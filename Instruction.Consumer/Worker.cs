...
public class Worker : BackgroundService
{
    ...
    private async Task<HttpResponseMessage> SendMessageViaSms(string Url, InstructionOrderEvent model)
    {
        ...
        _logger.LogInformation($"{model.UpdatedDate} da, {model.UserId} UserId'li kullanýcýýn ${model.Amount} Tutarlý Emri gerçekleþtirilmiþ ve {((Enums.NotificationType)model.NotificationType).GetDescription()} kanalý üzerinden bilgilendirilmiþtir.");
        return response;
    }
